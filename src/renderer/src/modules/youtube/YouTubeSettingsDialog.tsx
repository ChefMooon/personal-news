            ...
            <div>
              ...
              <div className="flex gap-2 mb-3">
                ...
                <Button
                  ...
                  onClick={() =>
                    setDraft((p) => ({ ...p, channelMode: "selected" }))
                  }
                >
                  Selected Only
                </Button>
              ...
              <p className="text-xs text-muted-foreground mt-1.5">
                ...
                <Pin className="inline h-3 w-3 text-amber-700 dark:text-amber-300" />
                ) appear first
              </p>
            </div>
            ...
            <div>
              ...
              >
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    setDraft((p) => ({ ...p, showUpcomingPanel: v }))
                  }
                />
              </SettingRow>
            </div>
              ...
              <div className="space-y-0.5">
                ...
                <SettingRow label="Show channel headers">
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      setDraft((p) => ({ ...p, showChannelHeaders: v }))
                    }
                  />
                </SettingRow>
            ...
            <div>
              <PerChannelOverrides
                ...
                onChange={(overrides) =>
                  setDraft((p) => ({
                    ...p,
                    perChannelMediaOverrides: overrides,
                  }))
                }
              />
            </div>
